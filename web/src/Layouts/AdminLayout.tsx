    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <aside
        className={`
          ...
          bg-emerald-950 text-white shadow-2xl shadow-emerald-950/10
        ...
        <div className="flex h-20 items-center justify-between border-b border-white/10 px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-emerald-200/70">Management</p>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={closeSidebar}
            className="rounded-lg p-2 text-emerald-100 transition hover:bg-white/10 lg:hidden"
          >
            <X size={19} />
          </button>
        </div>
